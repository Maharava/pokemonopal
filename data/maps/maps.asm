...
MapGroup_Olivine:
	...
	map OlivineLab, TILESET_LAB, INDOOR, LANDMARK_OLIVINE_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Azalea:
	...
	map MewGrove, TILESET_JOHTO, ENVIRONMENT_5, LANDMARK_ILEX_FOREST, MUSIC_NONE, TRUE, PALETTE_MORN,FISHGROUP_POND
