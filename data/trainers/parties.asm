...
FalknerGroup:
	...
	db  7, HOOTHOOT,     TACKLE, HYPNOSIS, NO_MOVE, NO_MOVE
	db 11, SKARMORY,   PECK, LEER, METAL_CLAW, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 16, SNUBBULL,   TACKLE, CHARM, BITE, NO_MOVE	
	db 18, CLEFAIRY,   DOUBLESLAP, MIMIC, DAZZ_GLM, METRONOME
...
BugsyGroup:
	...
	db 11, LEDYBA,    TACKLE, SUPERSONIC, LIGHT_SCREEN, NO_MOVE
	db 14, SPINARAK,     POISON_STING, STRING_SHOT, SCARY_FACE, TOXIC
	db 17, ARIADOS,    POISON_STING, NIGHT_SHADE, SLUDGE_BOMB, CONSTRICT
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 21, MURKROW,     PECK, PURSUIT, HAZE, NO_MOVE
	db 22, HOUNDOUR,    EMBER, SMOG, BITE, NO_MOVE
	db 24, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 27, MISDREAVUS,    PSYWAVE, CONFUSE_RAY, PSYBEAM, SHADOW_BALL
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 30, SWINUB,       HEADBUTT, POWDER_SNOW, ENDURE, MUD_SLAP
	db 33, SNEASEL,    FURY_SWIPES, ICY_WIND, TOXIC, FAINT_ATTACK
	db 35, PILOSWINE,  ICY_WIND, EARTHQUAKE, MIST, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 40, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 42, SKARMORY,  STEEL_WING, SWIFT, PROTECT, RETURN
	db 42, SCIZOR,  METAL_CLAW, TOXIC, FURY_CUTTER, DOUBLE_TEAM
	db 44, STEELIX,    SLAM, EARTHQUAKE, ROCK_THROW, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 30, TYROGUE,   TACKLE, HEADBUTT, ROCK_SMASH, MUD_SLAP
	db 33, PRIMEAPE,   LEER, RAGE, KARATE_CHOP, FURY_SWIPES
	db 35, HITMONTOP,  ROLLING_KICK, COUNTER, RAPID_SPIN, RETURN
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 44, MANTINE,  SURF, WHIRLPOOL, WING_ATTACK, RAIN_DANCE
	db 46, OCTILLERY,  OCTAZOOKA, HYPER_BEAM, FOCUS_ENERGY, ENDURE
	db 46, AZUMARILL,  DAZZ_GLM, HYDRO_PUMP, ROLLOUT, MEGA_PUNCH
...
Rival1Group:
	...
	db 38, GENGAR,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	...
	db 38, GENGAR,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 36, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 40, QUILAVA,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
...
WillGroup:
	...
	db 48, JYNX,       DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
...
BrunoGroup:
	...
	db 48, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 50, ONIX,       BIND, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 52, MACHAMP,    ROCK_SLIDE, FORESIGHT, VITAL_THROW, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 49, UMBREON,    SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
...
KogaGroup:
	...
	db 47, ARIADOS,    DOUBLE_TEAM, SPIDER_WEB, BATON_PASS, GIGA_DRAIN
	db 47, VENOMOTH,   SUPERSONIC, GUST, PSYCHIC_M, TOXIC
	db 51, FORRETRESS, PROTECT, SWIFT, EXPLOSION, SPIKES
...
ChampionGroup:
	...
	db 58, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
...
MistyGroup:
	...
	db 59, LAPRAS,     SURF, PERISH_SONG, BLIZZARD, RAIN_DANCE
	db 62, STARMIE,    SURF, DAZZ_GLM, RECOVER, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 59, RAICHU,     THUNDER_WAVE, QUICK_ATTACK, THUNDERBOLT, THUNDER
...
YoungsterGroup:
	...
	db "JOEY@", TRAINERTYPE_MOVES
	db 32, FURRET
	db 37, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end

	; YOUNGSTER (14)
	db "JOEY@", TRAINERTYPE_MOVES
	db 40, FURRET
	db 45, RATICATE,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
...
JanineGroup:
	...
	db 51, CROBAT,     SCREECH, SUPERSONIC, CONFUSE_RAY, WING_ATTACK
	db 51, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 51, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 48, ARIADOS,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
	db 54, VENOMOTH,   FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end
...
SabrinaGroup:
	...
	db 61, ESPEON,     SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYCHIC_M
	db 61, MR__MIME,   BARRIER, REFLECT, BATON_PASS, PSYCHIC_M
	db 63, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end
...
BugCatcherGroup:
	...
	db 32, LEDIAN
	db 32, LEDIAN
	db 34, BEEDRILL,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 38, BUTTERFREE, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end
	...
	db 45, LEDIAN
	db 45, LEDIAN
	db 47, BEEDRILL,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
	db 49, BUTTERFREE, PSYBEAM, SLEEP_POWDER, GUST, WHIRLWIND
	db -1 ; end
...
HikerGroup:
	...
	db 36, SHUCKLE
	db 41, GOLEM,      MAGNITUDE, SELFDESTRUCT, DEFENSE_CURL, ROLLOUT
	db 48, MACHAMP,    KARATE_CHOP, VITAL_THROW, HEADBUTT, DIG
	db -1 ; end
...
PicnickerGroup:
	...
	db 31, CLEFAIRY,   ENCORE, SING, DOUBLESLAP, DAZZ_GLM
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, CLEFAIRY,   ENCORE, SING, DOUBLESLAP, DAZZ_GLM
	db -1 ; end
	...
	db 38, JUMPLUFF,   STUN_SPORE, SUNNY_DAY, LEECH_SEED, COTTON_SPORE
...
RedGroup:
	...
	db 78, ESPEON,     MUD_SLAP, DAZZ_GLM, SWIFT, PSYCHIC_M
...
BlueGroup:
	...
	db 71, RHYDON,     FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 73, GYARADOS,   TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 73, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	db 73, ARCANINE,   ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
